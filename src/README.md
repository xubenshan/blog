...
footer: MIT Licensed | Copyright © 2025-present 小熊
copyright: false
---
...
本人的基本情况如下：双非本北邮硕，目前研一，研究方向是通感一体化，做通信的同学应该知道这个方向很一般，并不好找工作。
转码才是唯一的选择。在`C++`和`JAVA`中选择了`C++`。

## :dart: 网站内容
网站的主要内容就是C++所需掌握的基本技术栈。包括如下内容：
* 编程基础
* 数据结构与算法
* 计算机网络
* 操作系统
