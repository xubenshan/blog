...
> 标准模板库和标准库有什么区别？
>
> 标准库是C++自带的代码库，包含多线程并发、智能指针、STL等等。所以STL实际上是标准库的子集。另外需要注意：C++没有标准网络库，所以在进行C++网络编程时，要么采用第三方库，要么采用操作系统提供的底层网络接口，比如Linux的socketAPI。
...
<img src="https://xubenshan-pic.oss-cn-beijing.aliyuncs.com/img/image-20251126150332253.png" alt="image-20251126150332253" style="zoom:67%;" />
