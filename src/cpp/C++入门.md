...
> ssh免密登录的流程：
>
> 1. 客户端选择一个候选身份，比如 ~/.ssh/id_ed25519
> 2. 客户端取出这个身份对应的公钥
> 3. 客户端问服务器：这个公钥你接受吗？
> 4. 服务器检查 authorized_keys，里面有没有这个公钥
> 5. 如果接受，服务器说：可以，证明你有私钥
> 6. 客户端用对应私钥签名
> 7. 服务器验证签名，通过后登录成功
>
> 误区：客户端不是遍历本地所有的pub公钥，而是遍历已知候选身份对应的公钥。
>
> 已知候选身份列表一般来源：
>
> 1. 默认私钥文件名
...
>    ~/.ssh/id_rsa
>    等
> 2. ~/.ssh/config 里的 IdentityFile
> 3. ssh-agent 里已经加载的密钥
> 4. 命令行 -i 指定的私钥
>
